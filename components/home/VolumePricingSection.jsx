...
export default function VolumePricingSection({ discountTiers = [] }) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <AnimatedReveal>
          <div className="border-b border-hairline pb-lg sm:pb-xl mb-2xl sm:mb-3xl">
            <SectionEyebrow text="Volume Pricing" />
            ...
            <AnimatedReveal key={`tier-${tier._id || index}`} delay={index * 0.1}>
              ...
              >
                ...
                <div className="p-xl sm:p-2xl flex flex-col h-full relative z-10">
                  ...
                  {/* Description */}
                  <p className="font-sans text-small sm:text-body text-steelblue/70 leading-relaxed mb-lg sm:mb-xl flex-grow">
                    Enroll in {tier.minCourses} or more courses and unlock instant savings on your total package.
                  </p>
